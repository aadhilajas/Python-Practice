...
SELECT 
    ...
    R.DropoffLocation
FROM Users U
LEFT JOIN Rides R ON U.UserID = R.UserID;
...
SELECT 
    ...
    R.DropoffLocation
FROM Users U
RIGHT JOIN Rides R ON U.UserID = R.UserID;
...
# Self Join
SELECT 
    R1.RideID AS Ride1ID, 
    R2.RideID AS Ride2ID, 
    R1.PickupLocation
FROM Rides R1
INNER JOIN Rides R2 ON R1.PickupLocation = R2.PickupLocation AND R1.RideID <> R2.RideID;
